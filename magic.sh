...
sudo cp ./Qogir-icon-theme/src/32/places/default-network.svg /usr/share/icons/Papirus/32x32/places/folder-blue-network.svg
sudo cp ./Qogir-icon-theme/src/48/places/default-network.svg /usr/share/icons/Papirus/48x48/places/folder-blue-network.svg
sudo cp ./Qogir-icon-theme/src/scalable/places/default-network.svg /usr/share/icons/Papirus/64x64/places/folder-blue-network.svg

sudo cp ./Qogir-icon-theme/src/32/places/default-user-desktop.svg /usr/share/icons/Papirus/32x32/places/user-blue-desktop.svg
